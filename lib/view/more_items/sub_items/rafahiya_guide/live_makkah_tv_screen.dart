...
class LiveMakkahTvScreen extends StatefulWidget {
  const LiveMakkahTvScreen({super.key});

  @override
  State<LiveMakkahTvScreen> createState() => _LiveMakkahTvScreenState();
}

class _LiveMakkahTvScreenState extends State<LiveMakkahTvScreen> {
  ...
  void _initializePlayer() {
    try {
      final videoUrl = _streamProvider.makkahUrl; // or madinahUrl for Madinah screen
...
// Add this helper method to your screen classes
  ...
  Map<String, String> _getSaudiPrayerTimes() {
    ...
    final makkah = tz.getLocation('Asia/Riyadh');
    final currentDate = tz.TZDateTime.from(now, makkah);
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(AppStrings.getString('retry', currentLocale)),
                ),
              ],
            ),
          ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            AppStrings.getString('liveMakkahTv', currentLocale),
            style: GoogleFonts.poppins(
              color: Colors.white,
              fontSize: 17,
              fontWeight: FontWeight.w600,
          ...
          IconButton(
            ...
            onPressed: () => _showAboutDialog(currentLocale),
          ),
        ],
      ),
    );
        ...
        children: [
          Row(
            ...
            children: [
              ...
              _controlButton(Icons.share, () => _shareStream(currentLocale)),
            ],
          ),
          ...
          const SizedBox(height: 12),
          Text(
            AppStrings.getString('liveFromHolyMosque', currentLocale),
  ...
  Widget _controlButton(IconData icon, VoidCallback onPressed) {
    return IconButton(icon: Icon(icon, color: Colors.white), iconSize: 28, onPressed: onPressed);
  }
  ...
  void _shareStream(String currentLocale) async {
    final url = _streamProvider.makkahUrl;
    await Share.share(
      '${AppStrings.getString('watchFromMasjidAlHaram', currentLocale)}: $url',
      subject: 'Live Makkah TV Stream',
    );
  }
        ...
        return Dialog(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppStrings.getString('aboutLiveMakkahTv', currentLocale),
                  style: GoogleFonts.poppins(
                ...
                Text(
                  ...
                  style: GoogleFonts.poppins(color: AppColors.blackColor.withOpacity(0.9), fontSize: 14),
                ),
