...
//
//     final quranSurahListModel = quranSurahListModelFromJson(jsonString);

import 'dart:convert';

QuranSurahListModel quranSurahListModelFromJson(String str) => QuranSurahListModel.fromJson(json.decode(str));

String quranSurahListModelToJson(QuranSurahListModel data) => json.encode(data.toJson());

class QuranSurahListModel {
  int code;
  String status;
  Data data;
  ...
  factory QuranSurahListModel.fromJson(Map<String, dynamic> json) => QuranSurahListModel(
    code: json["code"],
    status: json["status"],
