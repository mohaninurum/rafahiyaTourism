...
//
//     print("✅ NotificationService.initialize CALLED with userId=$currentUserId");
//
...
//
//       print("🔥 FOREGROUND NOTIFICATION ARRIVED");
//
//       print("Title: ${message.notification?.title}");
//       print("Body: ${message.notification?.body}");
//
//       // Android notification channel
//       print("CHANNEL FROM ANDROID BLOCK ➜ ${message.notification?.android?.channelId}");
//
//       // If coming via data payload
//       print("CHANNEL FROM DATA ➜ ${message.data['android_channel_id']}");
...
//   AndroidNotification? android = message.notification?.android;
//
//   print("🔥 BACKGROUND / TERMINATED NOTIFICATION");
...
class NotificationServicesCode {}
